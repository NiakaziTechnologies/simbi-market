...
import { salesOverTime, unfulfilledOrdersOverTime, computeKPIs, computeZimScore, computeLowStockProducts, getUncompletedOrders, computePotentialLosses, filterOrdersByPeriod, PeriodFilter } from "@/lib/metrics";
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        // Load orders from API instead of localStorage/mock data
        if (accessToken) {
          // Try to get orders from API
          const data = await apiClient.request<{ success: boolean; message: string; data?: { orders: any[] } }>(
            '/api/seller/orders',
            {
              method: 'GET',
              headers: {
          ...
          <div className="premium-card p-8 border border-red-200/50 shadow-2xl relative overflow-hidden">
            ...
            <div className="flex items-center gap-6 relative">
              ...
              <div className="space-y-3">
                <h1 className="text-3xl font-bold text-red-800">Error Loading Analytics</h1>
